...
public class TosetModelList {
    ...
    public TosetModelList(String id, String leadId, String userId, String agentId, String alternate_number, String createdBy, String country, String state, String district, String mandal, String village, String pincode, String address, String serviceType, String categoryId, String subCategoryId, String statusCompleted, String dateLead, String timeLead, String venueString, String remarksString, String lead_type, String lead_source, String amount, String createdAt, String userName, String mobileNumber, String emailString, String countryString, String stateString, String districtString, String mandalString, String villageString, String pincodeString, String categoryName, String subCategoryName, String title) {
        this.id = id;
        this.leadId = leadId;
        this.userId = userId;
        ...
        this.mandalString = mandalString;
